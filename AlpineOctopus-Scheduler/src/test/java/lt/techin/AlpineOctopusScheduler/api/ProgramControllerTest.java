...
//    ProgramRepository programRepository;
    ...
    void getPrograms_returnsCorrectDtos() throws Exception {
        ...
        subjects1.add(toSubject(subjectDto2));
        subjects1.add(toSubject(subjectDto3));
        subjects2.add(toSubject(subjectDto1));
        subjects2.add(toSubject(subjectDto4));
        subjects2.add(toSubject(subjectDto3));
        subjects3.add(toSubject(subjectDto1));
        subjects4.add(toSubject(subjectDto1));
        subjects5.add(toSubject(subjectDto2));
