...
//    SubjectRepository subjectRepository;
    ...
    void getSubjects_returnsCorrectDtos() throws Exception {
        ...
        var subjectDto1 = new SubjectEntityDto(1l, "matke", "mat");
        var subjectDto2 = new SubjectEntityDto(2l, "fizika", "fiz");
        var subjectDto3 = new SubjectEntityDto(3l, "daile", "dai");
        var subjectDto4 = new SubjectEntityDto(4l, "darbeliai", "dar");
