...
ALTER TABLE modules_subjects
    ADD CONSTRAINT fk_modsub_on_module FOREIGN KEY (module_id) REFERENCES module (id);

ALTER TABLE modules_subjects
    ADD CONSTRAINT fk_modsub_on_subject FOREIGN KEY (subject_id) REFERENCES subject (id);
...
ALTER TABLE rooms_subjects
    ADD CONSTRAINT fk_roosub_on_room FOREIGN KEY (room_id) REFERENCES room (id);

ALTER TABLE rooms_subjects
    ADD CONSTRAINT fk_roosub_on_subject FOREIGN KEY (subject_id) REFERENCES subject (id);
...
ALTER TABLE teachers_subjects
    ADD CONSTRAINT fk_teasub_on_subject FOREIGN KEY (subject_id) REFERENCES subject (id);
...
ALTER TABLE groups_program
    ADD CONSTRAINT uc_groups_program_program UNIQUE (program_id);

ALTER TABLE groups_program
    ADD CONSTRAINT fk_gropro_on_groups FOREIGN KEY (subject_hours_id) REFERENCES GROUPS (id);

ALTER TABLE groups_program
    ADD CONSTRAINT fk_gropro_on_program FOREIGN KEY (program_id) REFERENCES program (id);
...
ALTER TABLE GROUPS
    ADD CONSTRAINT FK_GROUPS_ON_PROGRAM FOREIGN KEY (program_id) REFERENCES program (id);

ALTER TABLE GROUPS
    ADD CONSTRAINT FK_GROUPS_ON_SHIFT FOREIGN KEY (shift_id) REFERENCES shift (id);
...
ALTER TABLE teacher_shifts
    ADD CONSTRAINT fk_teashi_on_shift FOREIGN KEY (shift_id) REFERENCES shift (id);

ALTER TABLE teacher_shifts
    ADD CONSTRAINT fk_teashi_on_teacher FOREIGN KEY (teacher_id) REFERENCES teacher (id);