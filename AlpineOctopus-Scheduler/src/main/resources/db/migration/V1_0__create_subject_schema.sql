...
CREATE TABLE schedule_subjects (
  id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
   schedule_id BIGINT,
   lesson_id BIGINT,
   CONSTRAINT pk_schedulesubjects PRIMARY KEY (id)
);
...
ALTER TABLE schedule_subjects ADD CONSTRAINT FK_SCHEDULESUBJECTS_ON_LESSON FOREIGN KEY (lesson_id) REFERENCES lesson (id);

ALTER TABLE schedule_subjects ADD CONSTRAINT FK_SCHEDULESUBJECTS_ON_SCHEDULE FOREIGN KEY (schedule_id) REFERENCES schedule (id);
