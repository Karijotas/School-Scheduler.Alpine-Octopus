...
//    void deleteTeacherFromSubject(@Param("TEACHER_ID") Long teacherId, @Param("SUBJECT_ID") Long subjectId);
    ...
    List<Teacher> findDistinctByDeletedAndTeacherSubjects_NameContainingIgnoreCaseOrderByModifiedDateDesc(Boolean deleted, String subjectText);
    ...
    List<Teacher> findAllByTeacherSubjects_Id(Long subjectId);
}
