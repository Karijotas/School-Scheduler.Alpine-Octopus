...
export function ViewTeachers() {
  ...
  const fetchFilterTeachers = async () => {
    fetch(`/alpine-octopus/api/v1/teachers/page/name-filter/${nameText}`)
      .then((response) => response.json())
      .then((jsonRespone) => setTeachers(jsonRespone));
  };

  const fetchTeachersByShifts = async () => {
    fetch(`/alpine-octopus/api/v1/teachers/page/shift-filter/${shiftText}`)
      .then((response) => response.json())
      .then((jsonResponse) => setTeachers(jsonResponse));
  };

  const fetchFilterTeachersBySubjects = async () => {
    fetch(`/alpine-octopus/api/v1/teachers/page/subject-filter/${subjectText}?page=` + activePage)
      .then((response) => response.json())
      .then((jsonRespone) => setTeachers(jsonRespone));
  };
  ...
  const fetchTeachers = async () => {
    fetch(`/alpine-octopus/api/v1/teachers/page?page=` + activePage)
      .then((response) => response.json())
      .then((jsonRespones) => setTeachers(jsonRespones));
  };

  const removeTeacher = (id) => {
    fetch("/alpine-octopus/api/v1/teachers/delete/" + id, {
      method: "PATCH",
    }).then(fetchTeachers)
    .then(setOpen(false));
  };
  ...
  const fetchTeacherSubjects = async ()  => {
    fetch(`/alpine-octopus/api/v1/teachers/${teacherId}/subjects`)
      .then((response) => response.json())
