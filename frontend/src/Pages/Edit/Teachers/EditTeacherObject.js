...
export function EditTeacherObject() {
  ...
  useEffect(() => {
    fetch("/alpine-octopus/api/v1/teachers/" + params.id)
  ...
  const fetchTeacherShifts = () => {
    fetch(`/alpine-octopus/api/v1/teachers/${params.id}/shifts`)
      .then((response) => response.json())
  ...
  const fetchTeacherSubjects = () => {
    fetch(`/alpine-octopus/api/v1/teachers/${params.id}/subjects`)
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(`/alpine-octopus/api/v1/teachers/${params.id}/availableShifts`)
      .then((response) => response.json())
      .then((data) =>
        setShifts(
          data.map((x) => {
  ...
  const addShift = (teacherId, shiftId) => {
    fetch(`/alpine-octopus/api/v1/teachers/${teacherId}/shifts/${shiftId}/newShifts`, {
      method: "POST",
      header: JSON_HEADERS,
      body: JSON.stringify({
        teacherId,
  ...
  const removeShift = (teacherId, shiftId) => {
    fetch(`/alpine-octopus/api/v1/teachers/${teacherId}/shifts/${shiftId}`, {
      method: "DELETE",
      headers: JSON_HEADERS,
    })
      .then(fetchTeacherShifts);
  ...
  useEffect(() => {
    fetch(`/alpine-octopus/api/v1/teachers/${params.id}/availableSubjects`)
      .then((response) => response.json())
      .then((data) =>
        setSubjects(
          data.map((x) => {
  ...
  const addSubject = (teacherId, subjectId) => {
    fetch(`/alpine-octopus/api/v1/teachers/${teacherId}/subjects/${subjectId}/newSubjects`, {
      method: "POST",
      header: JSON_HEADERS,
      body: JSON.stringify({
        teacherId,
  ...
  const removeSubject = (teacherId, subjectId) => {
    fetch(`/alpine-octopus/api/v1/teachers/${teacherId}/subjects/${subjectId}`, {
      method: "DELETE",
      headers: JSON_HEADERS,
    }).then(fetchTeacherSubjects);
  };
