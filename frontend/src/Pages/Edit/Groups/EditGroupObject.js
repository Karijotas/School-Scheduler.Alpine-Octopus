          ...
          <Segment id="segment" raised color="teal">
            {active && (
              <div>
                ...
                <Button className="controls" onClick={editThis}>
                  Redaguoti
                </Button>
            ...
            {!active && (
              <div>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell collapsing>
                        <Input
                          ...
                          onChange={(e) => updateProperty("studentAmount", e)}
                        />
                      </Table.Cell>
                      <Table.Cell collapsing>
                        <Select
                          options={programs}
                          placeholder={groups.program.name}
                ...
                <Button className="controls" primary onClick={updateGroups}>
                  Atnaujinti
                </Button>
              </div>
            )}
