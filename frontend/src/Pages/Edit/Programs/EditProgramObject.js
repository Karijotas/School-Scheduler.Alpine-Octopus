...
export function EditProgramObject() {
  ...
  useEffect(() => {
    fetch("http://192.168.0.129:8081/scheduler/api/v1/programs/" + params.id)
      .then((response) => response.json())
      .then(setPrograms);
  }, []);

  useEffect(() => {
    fetch(`http://192.168.0.129:8081/scheduler/api/v1/programs/${params.id}/subjects`)
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(`http://192.168.0.129:8081/scheduler/api/v1/programs/${params.id}/subjects/hours`)
      .then((response) => response.json())
      .then(setTotalHours);
  }, [params]);

  const removeSubject = (programId, subjectId, hours) => {
    fetch(`http://192.168.0.129:8081/scheduler/api/v1/programs/${programId}/subjects/${subjectId}/${hours}`, {
      method: "DELETE",
  ...
  const addSubjectAndHours = (programId, subjectId, hours) => {
    fetch(`http://192.168.0.129:8081/scheduler/api/v1/programs/${programId}/subjects/${subjectId}/${hours}/newSubjectsWithHours`, {
      method: "POST",
      header: JSON_HEADERS,
      body: JSON.stringify({
        programId,
    ...
    }).then(fetch(`http://192.168.0.129:8081/scheduler//api/v1/programs/${params.id}/subjects/hours`)
      .then((response) => response.json())
      .then(setTotalHours));
  };
  ...
  useEffect(() => {
    fetch("http://192.168.0.129:8081/scheduler/api/v1/subjects/")
      .then((response) => response.json())
      .then((data) =>
        setSubjects(
          data.map((x) => {
