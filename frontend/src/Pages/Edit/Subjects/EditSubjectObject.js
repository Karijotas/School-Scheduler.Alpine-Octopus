...
export function EditSubjectObject() {
  ...
  useEffect(() => {
    fetch("/alpine/api/v1/subjects/" + params.id)
  ...
  const getModulesInSubjects = ()  => {
    fetch(`/alpine/api/v1/subjects/${params.id}/modules`)
      .then((response) => response.json())
  ...
  const getRoomsInSubjects = ()  => {
    fetch(`/alpine/api/v1/subjects/${params.id}/rooms`)
      .then((response) => response.json())
  ...
  const getTeachersInSubjects = ()  => {
    fetch(`/alpine/api/v1/subjects/${params.id}/teachers`)
      .then((response) => response.json())
  ...
  useEffect(() => {
    fetch(`/alpine/api/v1/subjects/${params.id}/availableModules`)
      .then((response) => response.json())
      .then((data) =>
        setModules(
          data.map((x) => {
  ...
  useEffect(() => {
    fetch(`/alpine/api/v1/subjects/${params.id}/availableTeachers`)
      .then((response) => response.json())
      .then((data) =>
        setTeachers(
          data.map((x) => {
  ...
  useEffect(() => {
    fetch(`/alpine/api/v1/subjects/${params.id}/availableRooms`)
      .then((response) => response.json())
      .then((data) =>
        setRooms(
          data.map((x) => {
  ...
  const addModule = (subjectId, moduleId) => {
    fetch(`/alpine/api/v1/subjects/${subjectId}/modules/${moduleId}/newModules`, {
      method: "POST",
      header: JSON_HEADERS,
      body: JSON.stringify({
        subjectId,
  ...
  const removeModule = (subjectId, moduleId) => {
    fetch(`/alpine/api/v1/subjects/${subjectId}/modules/${moduleId}`, {
      method: "DELETE",
      headers: JSON_HEADERS,
    }).then(getModulesInSubjects);
  };
  ...
  const addTeacher = (subjectId, teacherId) => {
    fetch(`/alpine/api/v1/subjects/${subjectId}/teachers/${teacherId}/newTeachers`, {
      method: "POST",
      header: JSON_HEADERS,
      body: JSON.stringify({
        subjectId,
  ...
  const removeTeacher = (subjectId, teacherId) => {
    fetch(`/alpine/api/v1/subjects/${subjectId}/teachers/${teacherId}`, {
      method: "DELETE",
      headers: JSON_HEADERS,
    }).then(getTeachersInSubjects)
    .then(setTeachersChange(false));
  ...
  const addRoom = (subjectId, roomId) => {
    fetch(`/alpine/api/v1/subjects/${subjectId}/rooms/${roomId}/newRooms`, {
      method: "POST",
      header: JSON_HEADERS,
      body: JSON.stringify({
        subjectId,
  ...
  const removeRoom = (subjectId, roomId) => {
    fetch(`/alpine/api/v1/subjects/${subjectId}/rooms/${roomId}`, {
      method: "DELETE",
      headers: JSON_HEADERS,
    }).then(getRoomsInSubjects);
  };
